...
{
    [TestFixture]
    internal class TMPostalCodeTests
    {
        ...
        {
            var code = new TMPostalCode(postalCode);
            var codePredecessor = new TMPostalCode(postalCodePredecessor);
        ...
        {
            var code = new TMPostalCode(postalCode);
            var codeSuccessor = new TMPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new TMPostalCode(postalCode)).Predecessor);
        }

        [TestCase("999999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new TMPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new TMPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new TMPostalCode(postalCodeBefore);
            var a = new TMPostalCode(postalCodeAfter);
        ...
        {
            var x = (new TMPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new TMPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(TMPostalCode));
        }
        ...
        {
            var x = (new TMPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(TMPostalCode));
        }
        ...
        {
            var x = (new TMPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(TMPostalCode));
        }
        ...
        {
            var x = (new TMPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(TMPostalCode));
        }
        ...
        {
            var x = new TMPostalCode(code);
            var y = new TMPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("TM");
