...
{
    [TestFixture]
    internal class EGPostalCodeTests
    {
        ...
        {
            var code = new EGPostalCode(postalCode);
            var codePredecessor = new EGPostalCode(postalCodePredecessor);
        ...
        {
            var code = new EGPostalCode(postalCode);
            var codeSuccessor = new EGPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new EGPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new EGPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new EGPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new EGPostalCode(postalCodeBefore);
            var a = new EGPostalCode(postalCodeAfter);
        ...
        {
            var x = (new EGPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new EGPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(EGPostalCode));
        }
        ...
        {
            var x = (new EGPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(EGPostalCode));
        }
        ...
        {
            var x = (new EGPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(EGPostalCode));
        }
        ...
        {
            var x = (new EGPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(EGPostalCode));
        }
        ...
        {
            var x = new EGPostalCode(code);
            var y = new EGPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("EG");
