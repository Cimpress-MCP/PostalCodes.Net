...
{
    [TestFixture]
    internal class PYPostalCodeTests
    {
        ...
        {
            var code = new PYPostalCode(postalCode);
            var codePredecessor = new PYPostalCode(postalCodePredecessor);
        ...
        {
            var code = new PYPostalCode(postalCode);
            var codeSuccessor = new PYPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new PYPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new PYPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new PYPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new PYPostalCode(postalCodeBefore);
            var a = new PYPostalCode(postalCodeAfter);
        ...
        {
            var x = (new PYPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new PYPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(PYPostalCode));
        }
        ...
        {
            var x = (new PYPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(PYPostalCode));
        }
        ...
        {
            var x = (new PYPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(PYPostalCode));
        }
        ...
        {
            var x = (new PYPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(PYPostalCode));
        }
        ...
        {
            var x = new PYPostalCode(code);
            var y = new PYPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("PY");
