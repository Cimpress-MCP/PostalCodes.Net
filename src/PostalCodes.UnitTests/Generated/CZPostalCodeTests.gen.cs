...
namespace PostalCodes.UnitTests.Generated
{
    ...
    internal class CZPostalCodeTests
    {
        ...
        {
            var b = new CZPostalCode(postalCodeBefore);
            var a = new CZPostalCode(postalCodeAfter);
        ...
        {
            var x = (new CZPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(CZPostalCode));
        }
        ...
        {
            var x = (new CZPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(CZPostalCode));
        }
        ...
        {
            var x = new CZPostalCode(code);
            var y = new CZPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("CZ");
