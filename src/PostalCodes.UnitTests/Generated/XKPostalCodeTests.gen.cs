...
{
    [TestFixture]
    internal class XKPostalCodeTests
    {
        ...
        {
            var code = new XKPostalCode(postalCode);
            var codePredecessor = new XKPostalCode(postalCodePredecessor);
        ...
        {
            var code = new XKPostalCode(postalCode);
            var codeSuccessor = new XKPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new XKPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new XKPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new XKPostalCode(postalCode));
        }
        ...
        {
            var x = (new XKPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new XKPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(XKPostalCode));
        }
        ...
        {
            var x = (new XKPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(XKPostalCode));
        }
        ...
        {
            var x = (new XKPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(XKPostalCode));
        }
        ...
        {
            var x = (new XKPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(XKPostalCode));
        }
        ...
        {
            var x = new XKPostalCode(code);
            var y = new XKPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("XK");
