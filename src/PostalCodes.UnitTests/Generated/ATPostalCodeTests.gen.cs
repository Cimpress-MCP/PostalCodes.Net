...
{
    [TestFixture]
    internal class ATPostalCodeTests
    {
        ...
        {
            var code = new ATPostalCode(postalCode);
            var codePredecessor = new ATPostalCode(postalCodePredecessor);
        ...
        {
            var code = new ATPostalCode(postalCode);
            var codeSuccessor = new ATPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new ATPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new ATPostalCode(postalCode)).Successor);
        }
        ...
        {
            var x = (new ATPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new ATPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(ATPostalCode));
        }
        ...
        {
            var x = (new ATPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(ATPostalCode));
        }
        ...
        {
            var x = (new ATPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(ATPostalCode));
        }
        ...
        {
            var x = (new ATPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(ATPostalCode));
        }
        ...
        {
            var x = new ATPostalCode(code);
            var y = new ATPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("AT");
