...
namespace PostalCodes.UnitTests.Generated
{
    ...
    internal class TWPostalCodeTests
    {
        ...
        {
            var code = new TWPostalCode(postalCode);
            var codePredecessor = new TWPostalCode(postalCodePredecessor);
        ...
        {
            var code = new TWPostalCode(postalCode);
            var codeSuccessor = new TWPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new TWPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new TWPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new TWPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new TWPostalCode(postalCodeBefore);
            var a = new TWPostalCode(postalCodeAfter);
        ...
        {
            var x = (new TWPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new TWPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(TWPostalCode));
        }
        ...
        {
            var x = (new TWPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(TWPostalCode));
        }
        ...
        {
            var x = (new TWPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(TWPostalCode));
        }
        ...
        {
            var x = (new TWPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(TWPostalCode));
        }
        ...
        {
            var x = new TWPostalCode(code);
            var y = new TWPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("TW");
