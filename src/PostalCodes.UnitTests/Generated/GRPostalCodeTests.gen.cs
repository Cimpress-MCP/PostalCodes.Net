...
{
    [TestFixture]
    internal class GRPostalCodeTests
    {
        ...
        {
            var code = new GRPostalCode(postalCode);
            var codePredecessor = new GRPostalCode(postalCodePredecessor);
        ...
        {
            var code = new GRPostalCode(postalCode);
            var codeSuccessor = new GRPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new GRPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new GRPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new GRPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new GRPostalCode(postalCodeBefore);
            var a = new GRPostalCode(postalCodeAfter);
        ...
        {
            var x = (new GRPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new GRPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(GRPostalCode));
        }
        ...
        {
            var x = (new GRPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(GRPostalCode));
        }
        ...
        {
            var x = (new GRPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(GRPostalCode));
        }
        ...
        {
            var x = (new GRPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(GRPostalCode));
        }
        ...
        {
            var x = new GRPostalCode(code);
            var y = new GRPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("GR");
