...
{
    [TestFixture]
    internal class CCPostalCodeTests
    {
        ...
        {
            var code = new CCPostalCode(postalCode);
            var codePredecessor = new CCPostalCode(postalCodePredecessor);
        ...
        {
            var code = new CCPostalCode(postalCode);
            var codeSuccessor = new CCPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new CCPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new CCPostalCode(postalCode)).Successor);
        }
        ...
        {
            var x = (new CCPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new CCPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(CCPostalCode));
        }
        ...
        {
            var x = (new CCPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(CCPostalCode));
        }
        ...
        {
            var x = (new CCPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(CCPostalCode));
        }
        ...
        {
            var x = (new CCPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(CCPostalCode));
        }
        ...
        {
            var x = new CCPostalCode(code);
            var y = new CCPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("CC");
