...
{
    [TestFixture]
    internal class GEPostalCodeTests
    {
        ...
        {
            var code = new GEPostalCode(postalCode);
            var codePredecessor = new GEPostalCode(postalCodePredecessor);
        ...
        {
            var code = new GEPostalCode(postalCode);
            var codeSuccessor = new GEPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new GEPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new GEPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new GEPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new GEPostalCode(postalCodeBefore);
            var a = new GEPostalCode(postalCodeAfter);
        ...
        {
            var x = (new GEPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new GEPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(GEPostalCode));
        }
        ...
        {
            var x = (new GEPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(GEPostalCode));
        }
        ...
        {
            var x = (new GEPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(GEPostalCode));
        }
        ...
        {
            var x = (new GEPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(GEPostalCode));
        }
        ...
        {
            var x = new GEPostalCode(code);
            var y = new GEPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("GE");
