...
{
    [TestFixture]
    internal class AMPostalCodeTests
    {
        ...
        {
            var code = new AMPostalCode(postalCode);
            var codePredecessor = new AMPostalCode(postalCodePredecessor);
        ...
        {
            var code = new AMPostalCode(postalCode);
            var codeSuccessor = new AMPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new AMPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new AMPostalCode(postalCode)).Successor);
        }
        ...
        {
            var x = (new AMPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new AMPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(AMPostalCode));
        }
        ...
        {
            var x = (new AMPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(AMPostalCode));
        }
        ...
        {
            var x = (new AMPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(AMPostalCode));
        }
        ...
        {
            var x = (new AMPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(AMPostalCode));
        }
        ...
        {
            var x = new AMPostalCode(code);
            var y = new AMPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("AM");
