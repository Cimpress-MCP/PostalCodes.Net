...
{
    [TestFixture]
    internal class TRPostalCodeTests
    {
        ...
        {
            var code = new TRPostalCode(postalCode);
            var codePredecessor = new TRPostalCode(postalCodePredecessor);
        ...
        {
            var code = new TRPostalCode(postalCode);
            var codeSuccessor = new TRPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new TRPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new TRPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new TRPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new TRPostalCode(postalCodeBefore);
            var a = new TRPostalCode(postalCodeAfter);
        ...
        {
            var x = (new TRPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new TRPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(TRPostalCode));
        }
        ...
        {
            var x = (new TRPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(TRPostalCode));
        }
        ...
        {
            var x = (new TRPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(TRPostalCode));
        }
        ...
        {
            var x = (new TRPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(TRPostalCode));
        }
        ...
        {
            var x = new TRPostalCode(code);
            var y = new TRPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("TR");
