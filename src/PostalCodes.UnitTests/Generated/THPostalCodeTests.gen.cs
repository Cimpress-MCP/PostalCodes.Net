...
{
    [TestFixture]
    internal class THPostalCodeTests
    {
        ...
        {
            var code = new THPostalCode(postalCode);
            var codePredecessor = new THPostalCode(postalCodePredecessor);
        ...
        {
            var code = new THPostalCode(postalCode);
            var codeSuccessor = new THPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new THPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new THPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new THPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new THPostalCode(postalCodeBefore);
            var a = new THPostalCode(postalCodeAfter);
        ...
        {
            var x = (new THPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new THPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(THPostalCode));
        }
        ...
        {
            var x = (new THPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(THPostalCode));
        }
        ...
        {
            var x = (new THPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(THPostalCode));
        }
        ...
        {
            var x = (new THPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(THPostalCode));
        }
        ...
        {
            var x = new THPostalCode(code);
            var y = new THPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("TH");
