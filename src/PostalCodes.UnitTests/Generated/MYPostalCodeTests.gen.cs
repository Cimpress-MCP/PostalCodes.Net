...
namespace PostalCodes.UnitTests.Generated
{
    ...
    internal class MYPostalCodeTests
    {
        ...
        {
            var b = new MYPostalCode(postalCodeBefore);
            var a = new MYPostalCode(postalCodeAfter);
        ...
        {
            var x = (new MYPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(MYPostalCode));
        }
        ...
        {
            var x = (new MYPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(MYPostalCode));
        }
        ...
        {
            var x = new MYPostalCode(code);
            var y = new MYPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("MY");
