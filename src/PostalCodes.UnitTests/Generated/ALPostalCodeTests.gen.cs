...
{
    [TestFixture]
    internal class ALPostalCodeTests
    {
        ...
        {
            var code = new ALPostalCode(postalCode);
            var codePredecessor = new ALPostalCode(postalCodePredecessor);
        ...
        {
            var code = new ALPostalCode(postalCode);
            var codeSuccessor = new ALPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new ALPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new ALPostalCode(postalCode)).Successor);
        }
        ...
        {
            var x = (new ALPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new ALPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(ALPostalCode));
        }
        ...
        {
            var x = (new ALPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(ALPostalCode));
        }
        ...
        {
            var x = (new ALPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(ALPostalCode));
        }
        ...
        {
            var x = (new ALPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(ALPostalCode));
        }
        ...
        {
            var x = new ALPostalCode(code);
            var y = new ALPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("AL");
