...
{
    [TestFixture]
    internal class TNPostalCodeTests
    {
        ...
        {
            var code = new TNPostalCode(postalCode);
            var codePredecessor = new TNPostalCode(postalCodePredecessor);
        ...
        {
            var code = new TNPostalCode(postalCode);
            var codeSuccessor = new TNPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new TNPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new TNPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new TNPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new TNPostalCode(postalCodeBefore);
            var a = new TNPostalCode(postalCodeAfter);
        ...
        {
            var x = (new TNPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new TNPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(TNPostalCode));
        }
        ...
        {
            var x = (new TNPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(TNPostalCode));
        }
        ...
        {
            var x = (new TNPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(TNPostalCode));
        }
        ...
        {
            var x = (new TNPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(TNPostalCode));
        }
        ...
        {
            var x = new TNPostalCode(code);
            var y = new TNPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("TN");
