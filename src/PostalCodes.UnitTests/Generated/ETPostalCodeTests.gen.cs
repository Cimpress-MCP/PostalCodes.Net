...
{
    [TestFixture]
    internal class ETPostalCodeTests
    {
        ...
        {
            var code = new ETPostalCode(postalCode);
            var codePredecessor = new ETPostalCode(postalCodePredecessor);
        ...
        {
            var code = new ETPostalCode(postalCode);
            var codeSuccessor = new ETPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new ETPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new ETPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new ETPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new ETPostalCode(postalCodeBefore);
            var a = new ETPostalCode(postalCodeAfter);
        ...
        {
            var x = (new ETPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new ETPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(ETPostalCode));
        }
        ...
        {
            var x = (new ETPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(ETPostalCode));
        }
        ...
        {
            var x = (new ETPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(ETPostalCode));
        }
        ...
        {
            var x = (new ETPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(ETPostalCode));
        }
        ...
        {
            var x = new ETPostalCode(code);
            var y = new ETPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("ET");
