...
{
    [TestFixture]
    internal class MZPostalCodeTests
    {
        ...
        {
            var code = new MZPostalCode(postalCode);
            var codePredecessor = new MZPostalCode(postalCodePredecessor);
        ...
        {
            var code = new MZPostalCode(postalCode);
            var codeSuccessor = new MZPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new MZPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new MZPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new MZPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new MZPostalCode(postalCodeBefore);
            var a = new MZPostalCode(postalCodeAfter);
        ...
        {
            var x = (new MZPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new MZPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(MZPostalCode));
        }
        ...
        {
            var x = (new MZPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(MZPostalCode));
        }
        ...
        {
            var x = (new MZPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(MZPostalCode));
        }
        ...
        {
            var x = (new MZPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(MZPostalCode));
        }
        ...
        {
            var x = new MZPostalCode(code);
            var y = new MZPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("MZ");
