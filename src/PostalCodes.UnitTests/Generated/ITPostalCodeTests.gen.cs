...
{
    [TestFixture]
    internal class ITPostalCodeTests
    {
        ...
        {
            var code = new ITPostalCode(postalCode);
            var codePredecessor = new ITPostalCode(postalCodePredecessor);
        ...
        {
            var code = new ITPostalCode(postalCode);
            var codeSuccessor = new ITPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new ITPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new ITPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new ITPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new ITPostalCode(postalCodeBefore);
            var a = new ITPostalCode(postalCodeAfter);
        ...
        {
            var x = (new ITPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new ITPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(ITPostalCode));
        }
        ...
        {
            var x = (new ITPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(ITPostalCode));
        }
        ...
        {
            var x = (new ITPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(ITPostalCode));
        }
        ...
        {
            var x = (new ITPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(ITPostalCode));
        }
        ...
        {
            var x = new ITPostalCode(code);
            var y = new ITPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("IT");
