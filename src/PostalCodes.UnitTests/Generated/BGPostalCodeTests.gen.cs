...
{
    [TestFixture]
    internal class BGPostalCodeTests
    {
        ...
        {
            var code = new BGPostalCode(postalCode);
            var codePredecessor = new BGPostalCode(postalCodePredecessor);
        ...
        {
            var code = new BGPostalCode(postalCode);
            var codeSuccessor = new BGPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new BGPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new BGPostalCode(postalCode)).Successor);
        }
        ...
        {
            var x = (new BGPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new BGPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(BGPostalCode));
        }
        ...
        {
            var x = (new BGPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(BGPostalCode));
        }
        ...
        {
            var x = (new BGPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(BGPostalCode));
        }
        ...
        {
            var x = (new BGPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(BGPostalCode));
        }
        ...
        {
            var x = new BGPostalCode(code);
            var y = new BGPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("BG");
