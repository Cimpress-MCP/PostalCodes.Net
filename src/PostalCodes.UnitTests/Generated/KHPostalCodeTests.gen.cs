...
{
    [TestFixture]
    internal class KHPostalCodeTests
    {
        ...
        {
            var code = new KHPostalCode(postalCode);
            var codePredecessor = new KHPostalCode(postalCodePredecessor);
        ...
        {
            var code = new KHPostalCode(postalCode);
            var codeSuccessor = new KHPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new KHPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new KHPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new KHPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new KHPostalCode(postalCodeBefore);
            var a = new KHPostalCode(postalCodeAfter);
        ...
        {
            var x = (new KHPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new KHPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(KHPostalCode));
        }
        ...
        {
            var x = (new KHPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(KHPostalCode));
        }
        ...
        {
            var x = (new KHPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(KHPostalCode));
        }
        ...
        {
            var x = (new KHPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(KHPostalCode));
        }
        ...
        {
            var x = new KHPostalCode(code);
            var y = new KHPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("KH");
