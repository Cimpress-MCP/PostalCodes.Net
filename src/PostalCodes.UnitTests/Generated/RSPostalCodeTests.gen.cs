...
{
    [TestFixture]
    internal class RSPostalCodeTests
    {
        ...
        {
            var code = new RSPostalCode(postalCode);
            var codePredecessor = new RSPostalCode(postalCodePredecessor);
        ...
        {
            var code = new RSPostalCode(postalCode);
            var codeSuccessor = new RSPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new RSPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new RSPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new RSPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new RSPostalCode(postalCodeBefore);
            var a = new RSPostalCode(postalCodeAfter);
        ...
        {
            var x = (new RSPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new RSPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(RSPostalCode));
        }
        ...
        {
            var x = (new RSPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(RSPostalCode));
        }
        ...
        {
            var x = (new RSPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(RSPostalCode));
        }
        ...
        {
            var x = (new RSPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(RSPostalCode));
        }
        ...
        {
            var x = new RSPostalCode(code);
            var y = new RSPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("RS");
