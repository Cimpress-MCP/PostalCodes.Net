...
{
    [TestFixture]
    internal class CUPostalCodeTests
    {
        ...
        {
            var code = new CUPostalCode(postalCode);
            var codePredecessor = new CUPostalCode(postalCodePredecessor);
        ...
        {
            var code = new CUPostalCode(postalCode);
            var codeSuccessor = new CUPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new CUPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new CUPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new CUPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new CUPostalCode(postalCodeBefore);
            var a = new CUPostalCode(postalCodeAfter);
        ...
        {
            var x = (new CUPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new CUPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(CUPostalCode));
        }
        ...
        {
            var x = (new CUPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(CUPostalCode));
        }
        ...
        {
            var x = (new CUPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(CUPostalCode));
        }
        ...
        {
            var x = (new CUPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(CUPostalCode));
        }
        ...
        {
            var x = new CUPostalCode(code);
            var y = new CUPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("CU");
