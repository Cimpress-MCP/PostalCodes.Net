...
{
    [TestFixture]
    internal class EEPostalCodeTests
    {
        ...
        {
            var code = new EEPostalCode(postalCode);
            var codePredecessor = new EEPostalCode(postalCodePredecessor);
        ...
        {
            var code = new EEPostalCode(postalCode);
            var codeSuccessor = new EEPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new EEPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new EEPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new EEPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new EEPostalCode(postalCodeBefore);
            var a = new EEPostalCode(postalCodeAfter);
        ...
        {
            var x = (new EEPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new EEPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(EEPostalCode));
        }
        ...
        {
            var x = (new EEPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(EEPostalCode));
        }
        ...
        {
            var x = (new EEPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(EEPostalCode));
        }
        ...
        {
            var x = (new EEPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(EEPostalCode));
        }
        ...
        {
            var x = new EEPostalCode(code);
            var y = new EEPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("EE");
