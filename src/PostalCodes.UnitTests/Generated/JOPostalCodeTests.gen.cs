...
{
    [TestFixture]
    internal class JOPostalCodeTests
    {
        ...
        {
            var code = new JOPostalCode(postalCode);
            var codePredecessor = new JOPostalCode(postalCodePredecessor);
        ...
        {
            var code = new JOPostalCode(postalCode);
            var codeSuccessor = new JOPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new JOPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new JOPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new JOPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new JOPostalCode(postalCodeBefore);
            var a = new JOPostalCode(postalCodeAfter);
        ...
        {
            var x = (new JOPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new JOPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(JOPostalCode));
        }
        ...
        {
            var x = (new JOPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(JOPostalCode));
        }
        ...
        {
            var x = (new JOPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(JOPostalCode));
        }
        ...
        {
            var x = (new JOPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(JOPostalCode));
        }
        ...
        {
            var x = new JOPostalCode(code);
            var y = new JOPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("JO");
