...
{
    [TestFixture]
    internal class DZPostalCodeTests
    {
        ...
        {
            var code = new DZPostalCode(postalCode);
            var codePredecessor = new DZPostalCode(postalCodePredecessor);
        ...
        {
            var code = new DZPostalCode(postalCode);
            var codeSuccessor = new DZPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new DZPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new DZPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new DZPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new DZPostalCode(postalCodeBefore);
            var a = new DZPostalCode(postalCodeAfter);
        ...
        {
            var x = (new DZPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new DZPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(DZPostalCode));
        }
        ...
        {
            var x = (new DZPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(DZPostalCode));
        }
        ...
        {
            var x = (new DZPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(DZPostalCode));
        }
        ...
        {
            var x = (new DZPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(DZPostalCode));
        }
        ...
        {
            var x = new DZPostalCode(code);
            var y = new DZPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("DZ");
