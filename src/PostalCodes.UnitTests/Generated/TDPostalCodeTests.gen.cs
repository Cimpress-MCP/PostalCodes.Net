...
{
    [TestFixture]
    internal class TDPostalCodeTests
    {
        ...
        {
            var code = new TDPostalCode(postalCode);
            var codePredecessor = new TDPostalCode(postalCodePredecessor);
        ...
        {
            var code = new TDPostalCode(postalCode);
            var codeSuccessor = new TDPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new TDPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new TDPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new TDPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new TDPostalCode(postalCodeBefore);
            var a = new TDPostalCode(postalCodeAfter);
        ...
        {
            var x = (new TDPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new TDPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(TDPostalCode));
        }
        ...
        {
            var x = (new TDPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(TDPostalCode));
        }
        ...
        {
            var x = (new TDPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(TDPostalCode));
        }
        ...
        {
            var x = (new TDPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(TDPostalCode));
        }
        ...
        {
            var x = new TDPostalCode(code);
            var y = new TDPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("TD");
