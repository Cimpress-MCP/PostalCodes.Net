...
{
    [TestFixture]
    internal class NGPostalCodeTests
    {
        ...
        {
            var code = new NGPostalCode(postalCode);
            var codePredecessor = new NGPostalCode(postalCodePredecessor);
        ...
        {
            var code = new NGPostalCode(postalCode);
            var codeSuccessor = new NGPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new NGPostalCode(postalCode)).Predecessor);
        }

        [TestCase("999999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new NGPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new NGPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new NGPostalCode(postalCodeBefore);
            var a = new NGPostalCode(postalCodeAfter);
        ...
        {
            var x = (new NGPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new NGPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(NGPostalCode));
        }
        ...
        {
            var x = (new NGPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(NGPostalCode));
        }
        ...
        {
            var x = (new NGPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(NGPostalCode));
        }
        ...
        {
            var x = (new NGPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(NGPostalCode));
        }
        ...
        {
            var x = new NGPostalCode(code);
            var y = new NGPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("NG");
