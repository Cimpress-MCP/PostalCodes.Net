...
{
    [TestFixture]
    internal class HMPostalCodeTests
    {
        ...
        {
            var code = new HMPostalCode(postalCode);
            var codePredecessor = new HMPostalCode(postalCodePredecessor);
        ...
        {
            var code = new HMPostalCode(postalCode);
            var codeSuccessor = new HMPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new HMPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new HMPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new HMPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new HMPostalCode(postalCodeBefore);
            var a = new HMPostalCode(postalCodeAfter);
        ...
        {
            var x = (new HMPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new HMPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(HMPostalCode));
        }
        ...
        {
            var x = (new HMPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(HMPostalCode));
        }
        ...
        {
            var x = (new HMPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(HMPostalCode));
        }
        ...
        {
            var x = (new HMPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(HMPostalCode));
        }
        ...
        {
            var x = new HMPostalCode(code);
            var y = new HMPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("HM");
