...
{
    [TestFixture]
    internal class LYPostalCodeTests
    {
        ...
        {
            var code = new LYPostalCode(postalCode);
            var codePredecessor = new LYPostalCode(postalCodePredecessor);
        ...
        {
            var code = new LYPostalCode(postalCode);
            var codeSuccessor = new LYPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new LYPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new LYPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new LYPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new LYPostalCode(postalCodeBefore);
            var a = new LYPostalCode(postalCodeAfter);
        ...
        {
            var x = (new LYPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new LYPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(LYPostalCode));
        }
        ...
        {
            var x = (new LYPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(LYPostalCode));
        }
        ...
        {
            var x = (new LYPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(LYPostalCode));
        }
        ...
        {
            var x = (new LYPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(LYPostalCode));
        }
        ...
        {
            var x = new LYPostalCode(code);
            var y = new LYPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("LY");
