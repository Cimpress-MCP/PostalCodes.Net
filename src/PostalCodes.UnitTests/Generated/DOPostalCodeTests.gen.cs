...
{
    [TestFixture]
    internal class DOPostalCodeTests
    {
        ...
        public void Predecessor_ValidInput_ReturnsCorrectPostalCode(string postalCode, string postalCodePredecessor)
        {
            ...
            var codePredecessor = new DOPostalCode(postalCodePredecessor);
        ...
        {
            Assert.IsNull((new DOPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new DOPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new DOPostalCode(postalCode));
        }
        ...
        {
            var x = (new DOPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new DOPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(DOPostalCode));
        }
        ...
        {
            var x = (new DOPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(DOPostalCode));
        }
        ...
        {
            var x = (new DOPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(DOPostalCode));
        }
        ...
        {
            var x = (new DOPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(DOPostalCode));
        }
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("DO");
