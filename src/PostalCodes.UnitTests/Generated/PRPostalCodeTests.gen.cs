...
{
    [TestFixture]
    internal class PRPostalCodeTests
    {
        ...
        {
            var code = new PRPostalCode(postalCode);
            var codePredecessor = new PRPostalCode(postalCodePredecessor);
        ...
        {
            var code = new PRPostalCode(postalCode);
            var codeSuccessor = new PRPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new PRPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new PRPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new PRPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new PRPostalCode(postalCodeBefore);
            var a = new PRPostalCode(postalCodeAfter);
        ...
        {
            var x = (new PRPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new PRPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(PRPostalCode));
        }
        ...
        {
            var x = (new PRPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(PRPostalCode));
        }
        ...
        {
            var x = (new PRPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(PRPostalCode));
        }
        ...
        {
            var x = (new PRPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(PRPostalCode));
        }
        ...
        {
            var x = new PRPostalCode(code);
            var y = new PRPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("PR");
