...
{
    [TestFixture]
    internal class BTPostalCodeTests
    {
        ...
        {
            var code = new BTPostalCode(postalCode);
            var codePredecessor = new BTPostalCode(postalCodePredecessor);
        ...
        {
            var code = new BTPostalCode(postalCode);
            var codeSuccessor = new BTPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new BTPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new BTPostalCode(postalCode)).Successor);
        }
        ...
        {
            var x = (new BTPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new BTPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(BTPostalCode));
        }
        ...
        {
            var x = (new BTPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(BTPostalCode));
        }
        ...
        {
            var x = (new BTPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(BTPostalCode));
        }
        ...
        {
            var x = (new BTPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(BTPostalCode));
        }
        ...
        {
            var x = new BTPostalCode(code);
            var y = new BTPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("BT");
