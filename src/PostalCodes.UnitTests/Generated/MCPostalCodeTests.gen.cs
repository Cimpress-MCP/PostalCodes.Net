...
{
    [TestFixture]
    internal class MCPostalCodeTests
    {
        ...
        {
            var code = new MCPostalCode(postalCode);
            var codePredecessor = new MCPostalCode(postalCodePredecessor);
        ...
        {
            var code = new MCPostalCode(postalCode);
            var codeSuccessor = new MCPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new MCPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new MCPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new MCPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new MCPostalCode(postalCodeBefore);
            var a = new MCPostalCode(postalCodeAfter);
        ...
        {
            var x = (new MCPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new MCPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(MCPostalCode));
        }
        ...
        {
            var x = (new MCPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(MCPostalCode));
        }
        ...
        {
            var x = (new MCPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(MCPostalCode));
        }
        ...
        {
            var x = (new MCPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(MCPostalCode));
        }
        ...
        {
            var x = new MCPostalCode(code);
            var y = new MCPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("MC");
