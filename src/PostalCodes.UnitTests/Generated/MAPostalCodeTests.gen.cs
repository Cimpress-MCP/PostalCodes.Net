...
{
    [TestFixture]
    internal class MAPostalCodeTests
    {
        ...
        {
            var code = new MAPostalCode(postalCode);
            var codePredecessor = new MAPostalCode(postalCodePredecessor);
        ...
        {
            var code = new MAPostalCode(postalCode);
            var codeSuccessor = new MAPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new MAPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new MAPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new MAPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new MAPostalCode(postalCodeBefore);
            var a = new MAPostalCode(postalCodeAfter);
        ...
        {
            var x = (new MAPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new MAPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(MAPostalCode));
        }
        ...
        {
            var x = (new MAPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(MAPostalCode));
        }
        ...
        {
            var x = (new MAPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(MAPostalCode));
        }
        ...
        {
            var x = (new MAPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(MAPostalCode));
        }
        ...
        {
            var x = new MAPostalCode(code);
            var y = new MAPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("MA");
