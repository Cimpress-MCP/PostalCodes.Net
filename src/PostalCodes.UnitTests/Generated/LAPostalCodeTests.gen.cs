...
{
    [TestFixture]
    internal class LAPostalCodeTests
    {
        ...
        {
            var code = new LAPostalCode(postalCode);
            var codePredecessor = new LAPostalCode(postalCodePredecessor);
        ...
        {
            var code = new LAPostalCode(postalCode);
            var codeSuccessor = new LAPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new LAPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new LAPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new LAPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new LAPostalCode(postalCodeBefore);
            var a = new LAPostalCode(postalCodeAfter);
        ...
        {
            var x = (new LAPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new LAPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(LAPostalCode));
        }
        ...
        {
            var x = (new LAPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(LAPostalCode));
        }
        ...
        {
            var x = (new LAPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(LAPostalCode));
        }
        ...
        {
            var x = (new LAPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(LAPostalCode));
        }
        ...
        {
            var x = new LAPostalCode(code);
            var y = new LAPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("LA");
