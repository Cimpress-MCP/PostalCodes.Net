...
namespace PostalCodes.UnitTests.Generated
{
    ...
    internal class PWPostalCodeTests
    {
        ...
        {
            var b = new PWPostalCode(postalCodeBefore);
            var a = new PWPostalCode(postalCodeAfter);
        ...
        {
            var x = (new PWPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(PWPostalCode));
        }
        ...
        {
            var x = (new PWPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(PWPostalCode));
        }
        ...
        {
            var x = new PWPostalCode(code);
            var y = new PWPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("PW");
