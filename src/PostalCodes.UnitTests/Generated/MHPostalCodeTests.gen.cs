...
{
    [TestFixture]
    internal class MHPostalCodeTests
    {
        ...
        {
            var code = new MHPostalCode(postalCode);
            var codePredecessor = new MHPostalCode(postalCodePredecessor);
        ...
        {
            var code = new MHPostalCode(postalCode);
            var codeSuccessor = new MHPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new MHPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new MHPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new MHPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new MHPostalCode(postalCodeBefore);
            var a = new MHPostalCode(postalCodeAfter);
        ...
        {
            var x = (new MHPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new MHPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(MHPostalCode));
        }
        ...
        {
            var x = (new MHPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(MHPostalCode));
        }
        ...
        {
            var x = (new MHPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(MHPostalCode));
        }
        ...
        {
            var x = (new MHPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(MHPostalCode));
        }
        ...
        {
            var x = new MHPostalCode(code);
            var y = new MHPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("MH");
