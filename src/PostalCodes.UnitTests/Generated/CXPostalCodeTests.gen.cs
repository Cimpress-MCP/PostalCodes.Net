...
{
    [TestFixture]
    internal class CXPostalCodeTests
    {
        ...
        {
            var code = new CXPostalCode(postalCode);
            var codePredecessor = new CXPostalCode(postalCodePredecessor);
        ...
        {
            var code = new CXPostalCode(postalCode);
            var codeSuccessor = new CXPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new CXPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new CXPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new CXPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new CXPostalCode(postalCodeBefore);
            var a = new CXPostalCode(postalCodeAfter);
        ...
        {
            var x = (new CXPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new CXPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(CXPostalCode));
        }
        ...
        {
            var x = (new CXPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(CXPostalCode));
        }
        ...
        {
            var x = (new CXPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(CXPostalCode));
        }
        ...
        {
            var x = (new CXPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(CXPostalCode));
        }
        ...
        {
            var x = new CXPostalCode(code);
            var y = new CXPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("CX");
