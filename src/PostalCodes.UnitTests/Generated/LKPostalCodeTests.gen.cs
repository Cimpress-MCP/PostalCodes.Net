...
{
    [TestFixture]
    internal class LKPostalCodeTests
    {
        ...
        {
            var code = new LKPostalCode(postalCode);
            var codePredecessor = new LKPostalCode(postalCodePredecessor);
        ...
        {
            var code = new LKPostalCode(postalCode);
            var codeSuccessor = new LKPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new LKPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new LKPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new LKPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new LKPostalCode(postalCodeBefore);
            var a = new LKPostalCode(postalCodeAfter);
        ...
        {
            var x = (new LKPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new LKPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(LKPostalCode));
        }
        ...
        {
            var x = (new LKPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(LKPostalCode));
        }
        ...
        {
            var x = (new LKPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(LKPostalCode));
        }
        ...
        {
            var x = (new LKPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(LKPostalCode));
        }
        ...
        {
            var x = new LKPostalCode(code);
            var y = new LKPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("LK");
