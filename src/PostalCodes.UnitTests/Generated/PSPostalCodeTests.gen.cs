...
{
    [TestFixture]
    internal class PSPostalCodeTests
    {
        ...
        {
            var code = new PSPostalCode(postalCode);
            var codePredecessor = new PSPostalCode(postalCodePredecessor);
        ...
        {
            var code = new PSPostalCode(postalCode);
            var codeSuccessor = new PSPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new PSPostalCode(postalCode)).Predecessor);
        }

        [TestCase("999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new PSPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new PSPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new PSPostalCode(postalCodeBefore);
            var a = new PSPostalCode(postalCodeAfter);
        ...
        {
            var x = (new PSPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new PSPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(PSPostalCode));
        }
        ...
        {
            var x = (new PSPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(PSPostalCode));
        }
        ...
        {
            var x = (new PSPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(PSPostalCode));
        }
        ...
        {
            var x = (new PSPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(PSPostalCode));
        }
        ...
        {
            var x = new PSPostalCode(code);
            var y = new PSPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("PS");
