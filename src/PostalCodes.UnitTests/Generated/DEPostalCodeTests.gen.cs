...
namespace PostalCodes.UnitTests.Generated
{
    ...
    internal class DEPostalCodeTests
    {
        ...
        {
            var b = new DEPostalCode(postalCodeBefore);
            var a = new DEPostalCode(postalCodeAfter);
        ...
        {
            var x = (new DEPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(DEPostalCode));
        }
        ...
        {
            var x = (new DEPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(DEPostalCode));
        }
        ...
        {
            var x = new DEPostalCode(code);
            var y = new DEPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("DE");
