...
{
    [TestFixture]
    internal class NAPostalCodeTests
    {
        ...
        {
            var code = new NAPostalCode(postalCode);
            var codePredecessor = new NAPostalCode(postalCodePredecessor);
        ...
        {
            var code = new NAPostalCode(postalCode);
            var codeSuccessor = new NAPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new NAPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new NAPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new NAPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new NAPostalCode(postalCodeBefore);
            var a = new NAPostalCode(postalCodeAfter);
        ...
        {
            var x = (new NAPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new NAPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(NAPostalCode));
        }
        ...
        {
            var x = (new NAPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(NAPostalCode));
        }
        ...
        {
            var x = (new NAPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(NAPostalCode));
        }
        ...
        {
            var x = (new NAPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(NAPostalCode));
        }
        ...
        {
            var x = new NAPostalCode(code);
            var y = new NAPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("NA");
