...
{
    [TestFixture]
    internal class NPPostalCodeTests
    {
        ...
        {
            var code = new NPPostalCode(postalCode);
            var codePredecessor = new NPPostalCode(postalCodePredecessor);
        ...
        {
            var code = new NPPostalCode(postalCode);
            var codeSuccessor = new NPPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new NPPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new NPPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new NPPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new NPPostalCode(postalCodeBefore);
            var a = new NPPostalCode(postalCodeAfter);
        ...
        {
            var x = (new NPPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new NPPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(NPPostalCode));
        }
        ...
        {
            var x = (new NPPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(NPPostalCode));
        }
        ...
        {
            var x = (new NPPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(NPPostalCode));
        }
        ...
        {
            var x = (new NPPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(NPPostalCode));
        }
        ...
        {
            var x = new NPPostalCode(code);
            var y = new NPPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("NP");
