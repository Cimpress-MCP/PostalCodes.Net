...
{
    [TestFixture]
    internal class KWPostalCodeTests
    {
        ...
        {
            var code = new KWPostalCode(postalCode);
            var codePredecessor = new KWPostalCode(postalCodePredecessor);
        ...
        {
            var code = new KWPostalCode(postalCode);
            var codeSuccessor = new KWPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new KWPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new KWPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new KWPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new KWPostalCode(postalCodeBefore);
            var a = new KWPostalCode(postalCodeAfter);
        ...
        {
            var x = (new KWPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new KWPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(KWPostalCode));
        }
        ...
        {
            var x = (new KWPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(KWPostalCode));
        }
        ...
        {
            var x = (new KWPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(KWPostalCode));
        }
        ...
        {
            var x = (new KWPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(KWPostalCode));
        }
        ...
        {
            var x = new KWPostalCode(code);
            var y = new KWPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("KW");
