...
{
    [TestFixture]
    internal class GWPostalCodeTests
    {
        ...
        {
            var code = new GWPostalCode(postalCode);
            var codePredecessor = new GWPostalCode(postalCodePredecessor);
        ...
        {
            var code = new GWPostalCode(postalCode);
            var codeSuccessor = new GWPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new GWPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new GWPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new GWPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new GWPostalCode(postalCodeBefore);
            var a = new GWPostalCode(postalCodeAfter);
        ...
        {
            var x = (new GWPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new GWPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(GWPostalCode));
        }
        ...
        {
            var x = (new GWPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(GWPostalCode));
        }
        ...
        {
            var x = (new GWPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(GWPostalCode));
        }
        ...
        {
            var x = (new GWPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(GWPostalCode));
        }
        ...
        {
            var x = new GWPostalCode(code);
            var y = new GWPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("GW");
