...
{
    [TestFixture]
    internal class HNPostalCodeTests
    {
        ...
        {
            var code = new HNPostalCode(postalCode);
            var codePredecessor = new HNPostalCode(postalCodePredecessor);
        ...
        {
            var code = new HNPostalCode(postalCode);
            var codeSuccessor = new HNPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new HNPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new HNPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new HNPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new HNPostalCode(postalCodeBefore);
            var a = new HNPostalCode(postalCodeAfter);
        ...
        {
            var x = (new HNPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new HNPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(HNPostalCode));
        }
        ...
        {
            var x = (new HNPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(HNPostalCode));
        }
        ...
        {
            var x = (new HNPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(HNPostalCode));
        }
        ...
        {
            var x = (new HNPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(HNPostalCode));
        }
        ...
        {
            var x = new HNPostalCode(code);
            var y = new HNPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("HN");
