...
{
    [TestFixture]
    internal class SNPostalCodeTests
    {
        ...
        {
            var code = new SNPostalCode(postalCode);
            var codePredecessor = new SNPostalCode(postalCodePredecessor);
        ...
        {
            var code = new SNPostalCode(postalCode);
            var codeSuccessor = new SNPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new SNPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new SNPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new SNPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new SNPostalCode(postalCodeBefore);
            var a = new SNPostalCode(postalCodeAfter);
        ...
        {
            var x = (new SNPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new SNPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(SNPostalCode));
        }
        ...
        {
            var x = (new SNPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(SNPostalCode));
        }
        ...
        {
            var x = (new SNPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(SNPostalCode));
        }
        ...
        {
            var x = (new SNPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(SNPostalCode));
        }
        ...
        {
            var x = new SNPostalCode(code);
            var y = new SNPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("SN");
