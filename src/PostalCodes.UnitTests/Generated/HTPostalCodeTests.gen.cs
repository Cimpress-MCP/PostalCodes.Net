...
{
    [TestFixture]
    internal class HTPostalCodeTests
    {
        ...
        {
            var code = new HTPostalCode(postalCode);
            var codePredecessor = new HTPostalCode(postalCodePredecessor);
        ...
        {
            var code = new HTPostalCode(postalCode);
            var codeSuccessor = new HTPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new HTPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new HTPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new HTPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new HTPostalCode(postalCodeBefore);
            var a = new HTPostalCode(postalCodeAfter);
        ...
        {
            var x = (new HTPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new HTPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(HTPostalCode));
        }
        ...
        {
            var x = (new HTPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(HTPostalCode));
        }
        ...
        {
            var x = (new HTPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(HTPostalCode));
        }
        ...
        {
            var x = (new HTPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(HTPostalCode));
        }
        ...
        {
            var x = new HTPostalCode(code);
            var y = new HTPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("HT");
