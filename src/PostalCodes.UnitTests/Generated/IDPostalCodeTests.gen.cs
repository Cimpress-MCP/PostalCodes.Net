...
{
    [TestFixture]
    internal class IDPostalCodeTests
    {
        ...
        {
            var code = new IDPostalCode(postalCode);
            var codePredecessor = new IDPostalCode(postalCodePredecessor);
        ...
        {
            var code = new IDPostalCode(postalCode);
            var codeSuccessor = new IDPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new IDPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new IDPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new IDPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new IDPostalCode(postalCodeBefore);
            var a = new IDPostalCode(postalCodeAfter);
        ...
        {
            var x = (new IDPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new IDPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(IDPostalCode));
        }
        ...
        {
            var x = (new IDPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(IDPostalCode));
        }
        ...
        {
            var x = (new IDPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(IDPostalCode));
        }
        ...
        {
            var x = (new IDPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(IDPostalCode));
        }
        ...
        {
            var x = new IDPostalCode(code);
            var y = new IDPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("ID");
