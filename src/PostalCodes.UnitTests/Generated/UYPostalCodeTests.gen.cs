...
{
    [TestFixture]
    internal class UYPostalCodeTests
    {
        ...
        {
            var code = new UYPostalCode(postalCode);
            var codePredecessor = new UYPostalCode(postalCodePredecessor);
        ...
        {
            var code = new UYPostalCode(postalCode);
            var codeSuccessor = new UYPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new UYPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new UYPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new UYPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new UYPostalCode(postalCodeBefore);
            var a = new UYPostalCode(postalCodeAfter);
        ...
        {
            var x = (new UYPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new UYPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(UYPostalCode));
        }
        ...
        {
            var x = (new UYPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(UYPostalCode));
        }
        ...
        {
            var x = (new UYPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(UYPostalCode));
        }
        ...
        {
            var x = (new UYPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(UYPostalCode));
        }
        ...
        {
            var x = new UYPostalCode(code);
            var y = new UYPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("UY");
