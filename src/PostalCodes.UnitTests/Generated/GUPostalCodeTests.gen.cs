...
{
    [TestFixture]
    internal class GUPostalCodeTests
    {
        ...
        {
            var code = new GUPostalCode(postalCode);
            var codePredecessor = new GUPostalCode(postalCodePredecessor);
        ...
        {
            var code = new GUPostalCode(postalCode);
            var codeSuccessor = new GUPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new GUPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new GUPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new GUPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new GUPostalCode(postalCodeBefore);
            var a = new GUPostalCode(postalCodeAfter);
        ...
        {
            var x = (new GUPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new GUPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(GUPostalCode));
        }
        ...
        {
            var x = (new GUPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(GUPostalCode));
        }
        ...
        {
            var x = (new GUPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(GUPostalCode));
        }
        ...
        {
            var x = (new GUPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(GUPostalCode));
        }
        ...
        {
            var x = new GUPostalCode(code);
            var y = new GUPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("GU");
