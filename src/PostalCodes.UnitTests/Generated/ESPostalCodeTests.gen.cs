...
namespace PostalCodes.UnitTests.Generated
{
    ...
    internal class ESPostalCodeTests
    {
        ...
        {
            var b = new ESPostalCode(postalCodeBefore);
            var a = new ESPostalCode(postalCodeAfter);
        ...
        {
            var x = (new ESPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(ESPostalCode));
        }
        ...
        {
            var x = (new ESPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(ESPostalCode));
        }
        ...
        {
            var x = new ESPostalCode(code);
            var y = new ESPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("ES");
