...
{
    [TestFixture]
    internal class TJPostalCodeTests
    {
        ...
        {
            var code = new TJPostalCode(postalCode);
            var codePredecessor = new TJPostalCode(postalCodePredecessor);
        ...
        {
            var code = new TJPostalCode(postalCode);
            var codeSuccessor = new TJPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new TJPostalCode(postalCode)).Predecessor);
        }

        [TestCase("999999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new TJPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new TJPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new TJPostalCode(postalCodeBefore);
            var a = new TJPostalCode(postalCodeAfter);
        ...
        {
            var x = (new TJPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new TJPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(TJPostalCode));
        }
        ...
        {
            var x = (new TJPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(TJPostalCode));
        }
        ...
        {
            var x = (new TJPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(TJPostalCode));
        }
        ...
        {
            var x = (new TJPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(TJPostalCode));
        }
        ...
        {
            var x = new TJPostalCode(code);
            var y = new TJPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("TJ");
