...
{
    [TestFixture]
    internal class YTPostalCodeTests
    {
        ...
        {
            var code = new YTPostalCode(postalCode);
            var codePredecessor = new YTPostalCode(postalCodePredecessor);
        ...
        {
            var code = new YTPostalCode(postalCode);
            var codeSuccessor = new YTPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new YTPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new YTPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new YTPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new YTPostalCode(postalCodeBefore);
            var a = new YTPostalCode(postalCodeAfter);
        ...
        {
            var x = (new YTPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new YTPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(YTPostalCode));
        }
        ...
        {
            var x = (new YTPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(YTPostalCode));
        }
        ...
        {
            var x = (new YTPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(YTPostalCode));
        }
        ...
        {
            var x = (new YTPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(YTPostalCode));
        }
        ...
        {
            var x = new YTPostalCode(code);
            var y = new YTPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("YT");
