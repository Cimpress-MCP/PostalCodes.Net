...
{
    [TestFixture]
    internal class ECPostalCodeTests
    {
        ...
        {
            var code = new ECPostalCode(postalCode);
            var codePredecessor = new ECPostalCode(postalCodePredecessor);
        ...
        {
            var code = new ECPostalCode(postalCode);
            var codeSuccessor = new ECPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new ECPostalCode(postalCode)).Predecessor);
        }

        [TestCase("999999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new ECPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new ECPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new ECPostalCode(postalCodeBefore);
            var a = new ECPostalCode(postalCodeAfter);
        ...
        {
            var x = (new ECPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new ECPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(ECPostalCode));
        }
        ...
        {
            var x = (new ECPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(ECPostalCode));
        }
        ...
        {
            var x = (new ECPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(ECPostalCode));
        }
        ...
        {
            var x = (new ECPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(ECPostalCode));
        }
        ...
        {
            var x = new ECPostalCode(code);
            var y = new ECPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("EC");
