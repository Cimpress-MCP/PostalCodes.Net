...
{
    [TestFixture]
    internal class IQPostalCodeTests
    {
        ...
        {
            var code = new IQPostalCode(postalCode);
            var codePredecessor = new IQPostalCode(postalCodePredecessor);
        ...
        {
            var code = new IQPostalCode(postalCode);
            var codeSuccessor = new IQPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new IQPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new IQPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new IQPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new IQPostalCode(postalCodeBefore);
            var a = new IQPostalCode(postalCodeAfter);
        ...
        {
            var x = (new IQPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new IQPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(IQPostalCode));
        }
        ...
        {
            var x = (new IQPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(IQPostalCode));
        }
        ...
        {
            var x = (new IQPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(IQPostalCode));
        }
        ...
        {
            var x = (new IQPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(IQPostalCode));
        }
        ...
        {
            var x = new IQPostalCode(code);
            var y = new IQPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("IQ");
