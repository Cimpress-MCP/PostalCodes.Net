...
{
    [TestFixture]
    internal class MKPostalCodeTests
    {
        ...
        {
            Assert.IsNull((new MKPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new MKPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new MKPostalCode(postalCode));
        }
        ...
        {
            var x = (new MKPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new MKPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(MKPostalCode));
        }
        ...
        {
            var x = (new MKPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(MKPostalCode));
        }
        ...
        {
            var x = (new MKPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(MKPostalCode));
        }
        ...
        {
            var x = (new MKPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(MKPostalCode));
        }
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("MK");
