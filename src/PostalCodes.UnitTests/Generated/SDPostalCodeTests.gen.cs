...
{
    [TestFixture]
    internal class SDPostalCodeTests
    {
        ...
        {
            var code = new SDPostalCode(postalCode);
            var codePredecessor = new SDPostalCode(postalCodePredecessor);
        ...
        {
            var code = new SDPostalCode(postalCode);
            var codeSuccessor = new SDPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new SDPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new SDPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new SDPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new SDPostalCode(postalCodeBefore);
            var a = new SDPostalCode(postalCodeAfter);
        ...
        {
            var x = (new SDPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new SDPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(SDPostalCode));
        }
        ...
        {
            var x = (new SDPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(SDPostalCode));
        }
        ...
        {
            var x = (new SDPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(SDPostalCode));
        }
        ...
        {
            var x = (new SDPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(SDPostalCode));
        }
        ...
        {
            var x = new SDPostalCode(code);
            var y = new SDPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("SD");
