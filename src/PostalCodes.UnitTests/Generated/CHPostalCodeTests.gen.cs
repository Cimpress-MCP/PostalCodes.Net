...
namespace PostalCodes.UnitTests.Generated
{
    ...
    internal class CHPostalCodeTests
    {
        ...
        {
            var x = (new CHPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(CHPostalCode));
        }
        ...
        {
            var x = (new CHPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(CHPostalCode));
        }
        ...
        {
            var x = new CHPostalCode(code);
            var y = new CHPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("CH");
