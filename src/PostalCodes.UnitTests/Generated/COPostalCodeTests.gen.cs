...
{
    [TestFixture]
    internal class COPostalCodeTests
    {
        ...
        {
            var code = new COPostalCode(postalCode);
            var codePredecessor = new COPostalCode(postalCodePredecessor);
        ...
        {
            var code = new COPostalCode(postalCode);
            var codeSuccessor = new COPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new COPostalCode(postalCode)).Predecessor);
        }

        [TestCase("999999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new COPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new COPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new COPostalCode(postalCodeBefore);
            var a = new COPostalCode(postalCodeAfter);
        ...
        {
            var x = (new COPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new COPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(COPostalCode));
        }
        ...
        {
            var x = (new COPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(COPostalCode));
        }
        ...
        {
            var x = (new COPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(COPostalCode));
        }
        ...
        {
            var x = (new COPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(COPostalCode));
        }
        ...
        {
            var x = new COPostalCode(code);
            var y = new COPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("CO");
