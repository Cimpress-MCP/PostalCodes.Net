...
{
    [TestFixture]
    internal class NIPostalCodeTests
    {
        ...
        {
            var code = new NIPostalCode(postalCode);
            var codePredecessor = new NIPostalCode(postalCodePredecessor);
        ...
        {
            var code = new NIPostalCode(postalCode);
            var codeSuccessor = new NIPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new NIPostalCode(postalCode)).Predecessor);
        }

        [TestCase("99999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new NIPostalCode(postalCode)).Successor);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new NIPostalCode(postalCode));
        }

        public void CompareTo_ReturnsExpectedSign(string postalCodeBefore, string postalCodeAfter)
        {
            var b = new NIPostalCode(postalCodeBefore);
            var a = new NIPostalCode(postalCodeAfter);
        ...
        {
            var x = (new NIPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new NIPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(NIPostalCode));
        }
        ...
        {
            var x = (new NIPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(NIPostalCode));
        }
        ...
        {
            var x = (new NIPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(NIPostalCode));
        }
        ...
        {
            var x = (new NIPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(NIPostalCode));
        }
        ...
        {
            var x = new NIPostalCode(code);
            var y = new NIPostalCode(code);
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("NI");
