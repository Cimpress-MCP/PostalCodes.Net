...
{
    [TestFixture]
    internal class BOPostalCodeTests
    {
        ...
        {
            var code = new BOPostalCode(postalCode);
            var codePredecessor = new BOPostalCode(postalCodePredecessor);
        ...
        {
            var code = new BOPostalCode(postalCode);
            var codeSuccessor = new BOPostalCode(postalCodeSuccessor);
        ...
        {
            Assert.IsNull((new BOPostalCode(postalCode)).Predecessor);
        }

        [TestCase("9999")]
        public void Successor_LastInRange_ReturnsNull(string postalCode)
        {
            Assert.IsNull((new BOPostalCode(postalCode)).Successor);
        }
        ...
        {
            var x = (new BOPostalCode(code)).Predecessor;
            bool result = true;
        ...
        {
            var x = (new BOPostalCode(code)).Predecessor;
            Assert.IsTrue(x.GetType() == typeof(BOPostalCode));
        }
        ...
        {
            var x = (new BOPostalCode(code)).Successor;
            Assert.IsTrue(x.GetType() == typeof(BOPostalCode));
        }
        ...
        {
            var x = (new BOPostalCode(code)).ExpandPostalCodeAsHighestInRange();
            Assert.IsTrue(x.GetType() == typeof(BOPostalCode));
        }
        ...
        {
            var x = (new BOPostalCode(code)).ExpandPostalCodeAsLowestInRange();
            Assert.IsTrue(x.GetType() == typeof(BOPostalCode));
        }
        ...
        {
            var country = CountryFactory.Instance.CreateCountry("BO");
